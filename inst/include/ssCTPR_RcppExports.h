...
#ifndef RCPP_ssCTPR_RCPPEXPORTS_H_GEN_
#define RCPP_ssCTPR_RCPPEXPORTS_H_GEN_
...
namespace ssCTPR {
    ...
    namespace {
        void validateSignature(const char* sig) {
            ...
            require("ssCTPR", Rcpp::Named("quietly") = true);
            typedef int(*Ptr_validate)(const char*);
            static Ptr_validate p_validate = (Ptr_validate)
                R_GetCCallable("ssCTPR", "_ssCTPR_RcppExport_validate");
            if (!p_validate(sig)) {
                throw Rcpp::function_not_exported(
                    "C++ function with signature '" + std::string(sig) + "' not found in ssCTPR");
            }
        }
    }
    ...
    inline int countlines(const char* fileName) {
        ...
        if (p_countlines == NULL) {
            ...
            p_countlines = (Ptr_countlines)R_GetCCallable("ssCTPR", "_ssCTPR_countlines");
        }
    ...
    inline arma::mat multiBed3(const std::string fileName, int N, int P, const arma::mat input, arma::Col<int> col_skip_pos, arma::Col<int> col_skip, arma::Col<int> keepbytes, arma::Col<int> keepoffset, const int trace) {
        ...
        if (p_multiBed3 == NULL) {
            ...
            p_multiBed3 = (Ptr_multiBed3)R_GetCCallable("ssCTPR", "_ssCTPR_multiBed3");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline arma::mat multiBed3sp(const std::string fileName, int N, int P, const arma::vec beta, const arma::Col<int> nonzeros, const arma::Col<int> colpos, const int ncol, arma::Col<int> col_skip_pos, arma::Col<int> col_skip, arma::Col<int> keepbytes, arma::Col<int> keepoffset, const int trace) {
        ...
        if (p_multiBed3sp == NULL) {
            ...
            p_multiBed3sp = (Ptr_multiBed3sp)R_GetCCallable("ssCTPR", "_ssCTPR_multiBed3sp");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline int elnet(double lambda1, double lambda2, double lambda_ct, const arma::vec& diag, const arma::mat& X, const arma::mat& r, double thr, arma::vec& x, arma::vec& yhat, int trace, int maxiter) {
        typedef SEXP(*Ptr_elnet)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_elnet p_elnet = NULL;
        if (p_elnet == NULL) {
            validateSignature("int(*elnet)(double,double,double,const arma::vec&,const arma::mat&,const arma::mat&,double,arma::vec&,arma::vec&,int,int)");
            p_elnet = (Ptr_elnet)R_GetCCallable("ssCTPR", "_ssCTPR_elnet");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_elnet(Shield<SEXP>(Rcpp::wrap(lambda1)), Shield<SEXP>(Rcpp::wrap(lambda2)), Shield<SEXP>(Rcpp::wrap(lambda_ct)), Shield<SEXP>(Rcpp::wrap(diag)), Shield<SEXP>(Rcpp::wrap(X)), Shield<SEXP>(Rcpp::wrap(r)), Shield<SEXP>(Rcpp::wrap(thr)), Shield<SEXP>(Rcpp::wrap(x)), Shield<SEXP>(Rcpp::wrap(yhat)), Shield<SEXP>(Rcpp::wrap(trace)), Shield<SEXP>(Rcpp::wrap(maxiter)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
    ...
    inline int repelnet(double lambda1, double lambda2, double lambda_ct, arma::vec& diag, arma::mat& X, arma::mat& r, double thr, arma::vec& x, arma::vec& yhat, int trace, int maxiter, arma::Col<int>& startvec, arma::Col<int>& endvec) {
        typedef SEXP(*Ptr_repelnet)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_repelnet p_repelnet = NULL;
        if (p_repelnet == NULL) {
            validateSignature("int(*repelnet)(double,double,double,arma::vec&,arma::mat&,arma::mat&,double,arma::vec&,arma::vec&,int,int,arma::Col<int>&,arma::Col<int>&)");
            p_repelnet = (Ptr_repelnet)R_GetCCallable("ssCTPR", "_ssCTPR_repelnet");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_repelnet(Shield<SEXP>(Rcpp::wrap(lambda1)), Shield<SEXP>(Rcpp::wrap(lambda2)), Shield<SEXP>(Rcpp::wrap(lambda_ct)), Shield<SEXP>(Rcpp::wrap(diag)), Shield<SEXP>(Rcpp::wrap(X)), Shield<SEXP>(Rcpp::wrap(r)), Shield<SEXP>(Rcpp::wrap(thr)), Shield<SEXP>(Rcpp::wrap(x)), Shield<SEXP>(Rcpp::wrap(yhat)), Shield<SEXP>(Rcpp::wrap(trace)), Shield<SEXP>(Rcpp::wrap(maxiter)), Shield<SEXP>(Rcpp::wrap(startvec)), Shield<SEXP>(Rcpp::wrap(endvec)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
    ...
    inline arma::mat genotypeMatrix(const std::string fileName, int N, int P, arma::Col<int> col_skip_pos, arma::Col<int> col_skip, arma::Col<int> keepbytes, arma::Col<int> keepoffset, const int fillmissing) {
        ...
        if (p_genotypeMatrix == NULL) {
            ...
            p_genotypeMatrix = (Ptr_genotypeMatrix)R_GetCCallable("ssCTPR", "_ssCTPR_genotypeMatrix");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline arma::vec normalize(arma::mat& genotypes) {
        ...
        if (p_normalize == NULL) {
            ...
            p_normalize = (Ptr_normalize)R_GetCCallable("ssCTPR", "_ssCTPR_normalize");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
    ...
    inline List runElnet(arma::vec& lambda, double shrink, double lambda_ct, const std::string fileName, arma::mat& r, int N, int P, arma::Col<int>& col_skip_pos, arma::Col<int>& col_skip, arma::Col<int>& keepbytes, arma::Col<int>& keepoffset, double thr, arma::vec& x, int trace, int maxiter, arma::Col<int>& startvec, arma::Col<int>& endvec) {
        typedef SEXP(*Ptr_runElnet)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_runElnet p_runElnet = NULL;
        if (p_runElnet == NULL) {
            validateSignature("List(*runElnet)(arma::vec&,double,double,const std::string,arma::mat&,int,int,arma::Col<int>&,arma::Col<int>&,arma::Col<int>&,arma::Col<int>&,double,arma::vec&,int,int,arma::Col<int>&,arma::Col<int>&)");
            p_runElnet = (Ptr_runElnet)R_GetCCallable("ssCTPR", "_ssCTPR_runElnet");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_runElnet(Shield<SEXP>(Rcpp::wrap(lambda)), Shield<SEXP>(Rcpp::wrap(shrink)), Shield<SEXP>(Rcpp::wrap(lambda_ct)), Shield<SEXP>(Rcpp::wrap(fileName)), Shield<SEXP>(Rcpp::wrap(r)), Shield<SEXP>(Rcpp::wrap(N)), Shield<SEXP>(Rcpp::wrap(P)), Shield<SEXP>(Rcpp::wrap(col_skip_pos)), Shield<SEXP>(Rcpp::wrap(col_skip)), Shield<SEXP>(Rcpp::wrap(keepbytes)), Shield<SEXP>(Rcpp::wrap(keepoffset)), Shield<SEXP>(Rcpp::wrap(thr)), Shield<SEXP>(Rcpp::wrap(x)), Shield<SEXP>(Rcpp::wrap(trace)), Shield<SEXP>(Rcpp::wrap(maxiter)), Shield<SEXP>(Rcpp::wrap(startvec)), Shield<SEXP>(Rcpp::wrap(endvec)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
...
#endif // RCPP_ssCTPR_RCPPEXPORTS_H_GEN_
