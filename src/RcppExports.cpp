...
// elnet
int elnet(double lambda1, double lambda2, double lambda_ct, const arma::vec& diag, const arma::mat& X, const arma::mat& r, double thr, arma::vec& x, arma::vec& yhat, int trace, int maxiter);
static SEXP _ssCTPR_elnet_try(SEXP lambda1SEXP, SEXP lambda2SEXP, SEXP lambda_ctSEXP, SEXP diagSEXP, SEXP XSEXP, SEXP rSEXP, SEXP thrSEXP, SEXP xSEXP, SEXP yhatSEXP, SEXP traceSEXP, SEXP maxiterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(elnet(lambda1, lambda2, lambda_ct, diag, X, r, thr, x, yhat, trace, maxiter));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _ssCTPR_elnet(SEXP lambda1SEXP, SEXP lambda2SEXP, SEXP lambda_ctSEXP, SEXP diagSEXP, SEXP XSEXP, SEXP rSEXP, SEXP thrSEXP, SEXP xSEXP, SEXP yhatSEXP, SEXP traceSEXP, SEXP maxiterSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_ssCTPR_elnet_try(lambda1SEXP, lambda2SEXP, lambda_ctSEXP, diagSEXP, XSEXP, rSEXP, thrSEXP, xSEXP, yhatSEXP, traceSEXP, maxiterSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
// repelnet
int repelnet(double lambda1, double lambda2, double lambda_ct, arma::vec& diag, arma::mat& X, arma::mat& r, double thr, arma::vec& x, arma::vec& yhat, int trace, int maxiter, arma::Col<int>& startvec, arma::Col<int>& endvec);
static SEXP _ssCTPR_repelnet_try(SEXP lambda1SEXP, SEXP lambda2SEXP, SEXP lambda_ctSEXP, SEXP diagSEXP, SEXP XSEXP, SEXP rSEXP, SEXP thrSEXP, SEXP xSEXP, SEXP yhatSEXP, SEXP traceSEXP, SEXP maxiterSEXP, SEXP startvecSEXP, SEXP endvecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< double >::type lambda1(lambda1SEXP);
    Rcpp::traits::input_parameter< double >::type lambda2(lambda2SEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(repelnet(lambda1, lambda2, lambda_ct, diag, X, r, thr, x, yhat, trace, maxiter, startvec, endvec));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _ssCTPR_repelnet(SEXP lambda1SEXP, SEXP lambda2SEXP, SEXP lambda_ctSEXP, SEXP diagSEXP, SEXP XSEXP, SEXP rSEXP, SEXP thrSEXP, SEXP xSEXP, SEXP yhatSEXP, SEXP traceSEXP, SEXP maxiterSEXP, SEXP startvecSEXP, SEXP endvecSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_ssCTPR_repelnet_try(lambda1SEXP, lambda2SEXP, lambda_ctSEXP, diagSEXP, XSEXP, rSEXP, thrSEXP, xSEXP, yhatSEXP, traceSEXP, maxiterSEXP, startvecSEXP, endvecSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
// runElnet
List runElnet(arma::vec& lambda, double shrink, double lambda_ct, const std::string fileName, arma::mat& r, int N, int P, arma::Col<int>& col_skip_pos, arma::Col<int>& col_skip, arma::Col<int>& keepbytes, arma::Col<int>& keepoffset, double thr, arma::vec& x, int trace, int maxiter, arma::Col<int>& startvec, arma::Col<int>& endvec);
static SEXP _ssCTPR_runElnet_try(SEXP lambdaSEXP, SEXP shrinkSEXP, SEXP lambda_ctSEXP, SEXP fileNameSEXP, SEXP rSEXP, SEXP NSEXP, SEXP PSEXP, SEXP col_skip_posSEXP, SEXP col_skipSEXP, SEXP keepbytesSEXP, SEXP keepoffsetSEXP, SEXP thrSEXP, SEXP xSEXP, SEXP traceSEXP, SEXP maxiterSEXP, SEXP startvecSEXP, SEXP endvecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    ...
    Rcpp::traits::input_parameter< arma::Col<int>& >::type startvec(startvecSEXP);
    Rcpp::traits::input_parameter< arma::Col<int>& >::type endvec(endvecSEXP);
    rcpp_result_gen = Rcpp::wrap(runElnet(lambda, shrink, lambda_ct, fileName, r, N, P, col_skip_pos, col_skip, keepbytes, keepoffset, thr, x, trace, maxiter, startvec, endvec));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _ssCTPR_runElnet(SEXP lambdaSEXP, SEXP shrinkSEXP, SEXP lambda_ctSEXP, SEXP fileNameSEXP, SEXP rSEXP, SEXP NSEXP, SEXP PSEXP, SEXP col_skip_posSEXP, SEXP col_skipSEXP, SEXP keepbytesSEXP, SEXP keepoffsetSEXP, SEXP thrSEXP, SEXP xSEXP, SEXP traceSEXP, SEXP maxiterSEXP, SEXP startvecSEXP, SEXP endvecSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_ssCTPR_runElnet_try(lambdaSEXP, shrinkSEXP, lambda_ctSEXP, fileNameSEXP, rSEXP, NSEXP, PSEXP, col_skip_posSEXP, col_skipSEXP, keepbytesSEXP, keepoffsetSEXP, thrSEXP, xSEXP, traceSEXP, maxiterSEXP, startvecSEXP, endvecSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _ssCTPR_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("int(*elnet)(double,double,double,const arma::vec&,const arma::mat&,const arma::mat&,double,arma::vec&,arma::vec&,int,int)");
        signatures.insert("int(*repelnet)(double,double,double,arma::vec&,arma::mat&,arma::mat&,double,arma::vec&,arma::vec&,int,int,arma::Col<int>&,arma::Col<int>&)");
        ...
        signatures.insert("List(*runElnet)(arma::vec&,double,double,const std::string,arma::mat&,int,int,arma::Col<int>&,arma::Col<int>&,arma::Col<int>&,arma::Col<int>&,double,arma::vec&,int,int,arma::Col<int>&,arma::Col<int>&)");
    }
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_ssCTPR_elnet", (DL_FUNC) &_ssCTPR_elnet, 11},
    {"_ssCTPR_repelnet", (DL_FUNC) &_ssCTPR_repelnet, 13},
    {"_ssCTPR_genotypeMatrix", (DL_FUNC) &_ssCTPR_genotypeMatrix, 8},
    {"_ssCTPR_normalize", (DL_FUNC) &_ssCTPR_normalize, 1},
    {"_ssCTPR_runElnet", (DL_FUNC) &_ssCTPR_runElnet, 17},
